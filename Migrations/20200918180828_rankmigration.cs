        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetUsers_AspUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AspUserId = table.Column<string>(nullable: true),
                    DECK_NAME = table.Column<string>(maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_decksTable", x => x.id);
                    table.ForeignKey(
                        name: "FK_decksTable_AspNetUsers_AspUserId",
                        column: x => x.AspUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    green = table.Column<string>(nullable: true),
                    blue = table.Column<string>(nullable: true),
                    decksTableKey = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
